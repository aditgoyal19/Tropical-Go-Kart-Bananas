...
int main(int argc, char* argv[])
{
	...
	glGenFramebuffers(1, &FrameBufferMiniMap);
	...
	std::cout<<"2 : Duel  "<<std::endl;

	char a;
	std::cin>>a;

	std::cout<<"Do you want to play BackGround Music ?? "<<std::endl;
	...
	if(sound == '1')
	{
	std::wstring soundFileName= L"sounds/GameJamTropical.mp3";
	std::wstring raceFileName= L"sounds/race.mp3";

	::myAudio->loadSound("STREAM",soundFileName);
	::myAudio->loadSound("SAMPLE",raceFileName);
